...
% for windows images
raslpara.canonicalImageSize = [ 29  29];    % 为什么是29 29？
raslpara.canonicalCoords = [ 5  24 ; ...    % 这是两个初始坐标点，分别是(5,15)、(24,15)
                             15 15  ];
                            
% parametric tranformation model
raslpara.transformType = 'EUCLIDEAN';   % 变换类型
...
% get initial transformation 初始变换信息
transformationInit = 'SIMILARITY';  % 相似变换需要2对点计算
